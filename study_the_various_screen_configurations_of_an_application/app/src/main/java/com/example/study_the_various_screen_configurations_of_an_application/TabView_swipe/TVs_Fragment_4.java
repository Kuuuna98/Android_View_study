...
public class TVs_Fragment_4 extends Fragment {


    public static TVs_Fragment_4 newInstance() {
        TVs_Fragment_4 fragment = new TVs_Fragment_4();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        textView.setText("네 번째 화면");
        textView.setBackgroundColor(Color.parseColor("#d5c2ee"));
        return fv;
    }

...
public class TabView_basic extends AppCompatActivity {

    private static final String TAG = "TabView_basic";

    private FragmentManager fragmentManager = getSupportFragmentManager();

    private TVb_Fragment_1 fragment_1 = new TVb_Fragment_1();
    private TVb_Fragment_2 fragment_2 = new TVb_Fragment_2();
    private TVb_Fragment_3 fragment_3 = new TVb_Fragment_3();
    private TVb_Fragment_4 fragment_4 = new TVb_Fragment_4();
